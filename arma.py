...
class Arma:
	...
	def __init__(self,clase,tipo,tipo_de_municion):
		...
		#Gaston: Los limites estos tambien deberian ser constantes para que se
		#        puedan cambiar mas facil
		...
		#Gaston: Siendo que no cambia nunca, podria estar hardcodeado
		# 		 en el metodo
	...
	def esta_lista(self):
		...
		#Gaston: Como idea tener una variable/atributo para saber si esta
		#        lista es mala idea (hay mas cosas que mantener). Pensa que
		#        lo podes calcular igual que por ej en la pila:
		#        return self.cantidad_de_recargas_faltantes <= 0
		#        eso aparte te simplifica el metodo de abajo porque no tenes
		#        que controlar nada nunca
		return self.disponible

	def recargar(self):
		"""Disminuye el tiempo de recarga, al llegar a cero el arma
		vuelve a estar disponible"""
		#Gaston: No metas todo en el if, pone la condicion opuesta y un return
...
def generar_lista_armas():
	...
	#Gaston: Devuelve una lista de armas random. El no recibe nada es redundante
	armas={}
